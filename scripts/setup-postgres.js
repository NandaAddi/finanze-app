...
/**
 * PostgreSQL Setup Script for Finance Manager
 * 
...
console.log('Setting up PostgreSQL for Finance Manager...\n');
...
try {
  ...
  console.log('3. Create your first wallet and track your transactions');
